        ...
        <div class="px-4 sm:px-6 lg:px-8 bg-white pt-4">
            ...
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Menu Categories</h1>
                    <p class="mt-2 text-sm text-gray-700">
                        A list of all the menu categories in your account including their name, slug and actions.
                    </p>
                </div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach ($menu_categories as $menu_category)
                                    <tr>
                                        ...
                                        <td
                                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                                            {{ $menu_category->name }}</td>
                                        <td
                                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                                            {{ $menu_category->slug }}</td>
                                        <td
                                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                                            <div class="flex gap-3">
                                                ...
                                                <a href="{{ route('menu-category.edit', $menu_category->id) }}"
                                                ...
                                                <form
                                                    action="{{ route('menu-category.destroy', $menu_category->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
